...
class TagKajianRecyclerAdapter :
    ListAdapter<String, TagKajianRecyclerAdapter.TagKajianViewHolder>(DiffUtilItemCallback.TAG_KAJIAN_DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TagKajianViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_tag_kajian, parent, false)
